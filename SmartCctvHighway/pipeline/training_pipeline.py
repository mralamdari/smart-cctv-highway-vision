...
from SmartCctvHighway.components.data_ingestion import DataIngestion
from SmartCctvHighway.components.data_validation import DataValidation
from SmartCctvHighway.components.model_trainer import ModelTrainer
# from SmartCctvHighway.components.model_pusher import ModelPusher
# from SmartCctvHighway.configuration.s3_operations import S3Operation
    ...
    def start_model_trainer(self
        ...
        try:
            model_trainer = ModelTrainer(
                ...
                model_data_config=self.data_ingestion_config,
            )
